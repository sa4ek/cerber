...
<p>Введите новый пароль, (login: <b><?php echo $act_password->user; ?></b>).</p>
<form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  <label for="password"><b>(new)</b> Пароль:</label>
...
<p><a href="<?php echo $act_password->login_page; ?>">Вход</a></p>
</body>
</html>
