...
// $test_page_protect->login_page = "index.php"; // change this only if your login is on another page
...
<title>Страница доступная зарегистрированным пользователям</title>
</head>

<body>
<h2><?php echo "Привет ".$hello_name." !"; ?></h2>
<p>Теперь у вас есть к ней доступ.</p>
